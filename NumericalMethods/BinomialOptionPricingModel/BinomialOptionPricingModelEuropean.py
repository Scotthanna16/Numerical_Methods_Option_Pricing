...
class BinomialOptionPricingModelEuropean(BinomialOptionPricingModel):
...
#     m1 = BinomialOptionPricingModelEuropean(
#         S0=100, K=110, r=0.07, delta=0.02, sigma=0.2, T=1, steps=200, option="call"
#     )
#     m2 = BinomialOptionPricingModelEuropean(
#         S0=100, K=110, r=0.07, delta=0.02, sigma=0.2, T=1, steps=200, option="put"
#     )

#     print("European Call:", m1.getprice())
#     print("European Put:", m2.getprice())
